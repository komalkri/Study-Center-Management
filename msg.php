...
#format{ background-color:#CCC}
#img{ position:relative; text-align:center; line-height:30px; background-color:#FFC; border:4px solid #666; -webkit-border-radius:30px; -moz-border-radius:30px; border-radius:30px; -webkit-box-shadow:2px 2px 4px #888; -moz-box-shadow:2px 2px 4px #888; box-shadow:2px 2px 4px #888;}
#img1{ position:relative; text-align:center; line-height:30px; background-color:#9CF; border:4px solid #666; -webkit-border-radius:30px; -moz-border-radius:30px; border-radius:30px; -webkit-box-shadow:2px 2px 4px #888; -moz-box-shadow:2px 2px 4px #888; box-shadow:2px 2px 4px #888;}
</style>
                        ...
                        <?php
                            ...
                            while($row = mysql_fetch_array($r1))
                            {
	                          ...
	                          <?php echo $usr;?></td></tr></table></td></tr>
	                           <tr><td align="center" ><?php echo '<p>'.$msg.'</p>';
							  ?></td></tr>
							   </table>
                             </div>
                               <?php }
							  ...
							  <?php echo '<h6><i class="icon-time"></i>'.$dt.'</h6>';?></td></tr></table></td></tr>
	                           <tr><td align="center" ><?php echo '<p>'.$msg.'</p>';?></td></tr>
							   </table>
                               </div>
	                          <?php 
                             }
                            ...
                            { 
	                           ...
	                           $q="INSERT INTO `message` (`id`, `message`, `user_name`) VALUES ('', '$msg', '$usr')";
	                           if(mysql_query($q))
							   {
								   ?>
                                   <div id="img">
...
{ 
	$msg=$_POST['message'];
	$usr=$_SESSION['logged_user'];
	$q="INSERT INTO `all_msg` (`id`, `message`, `user_name`) VALUES ('', '$msg', '$usr')";
	if(mysql_query($q)){
